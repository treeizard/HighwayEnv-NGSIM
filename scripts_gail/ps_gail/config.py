...
class PSGAILConfig:
    ...
    paper_style_training: bool = False
    paper_phase1_rounds: int = 1000
    paper_phase2_rounds: int = 200
    paper_phase1_gamma: float = 0.95
    paper_phase2_gamma: float = 0.99
    paper_phase1_agent_steps: int = 10_000
    paper_phase2_agent_steps: int = 40_000
    paper_initial_agent_count: int = 10
