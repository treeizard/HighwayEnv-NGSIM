"""Classic scalar, kinematic, grid, tuple, and rendered observations."""
...
def observation_factory(env: AbstractEnv, config: dict) -> ObservationType:
    """Resolve observation configurations without importing the factory at module load time."""
    from .factory import observation_factory as factory
