...
import sys
sys.path.append(
    r"C:\Users\teeds\OneDrive\Attachments\Desktop\projects\research\HIGH\HighwayEnv-NGSIM"
)
...
def build_trajecotry(scene, period, vehicle_ID):
    ...
    for position in selected_trajectory:
        print("RECORD TRAJECOTRY")
        print(record_trajectory)
...
if __name__ == "__main__":
    ...
    for id in np.random.choice(3200, size=300, replace=False):
        try:
            trajectory_set = build_trajecotry(scene, 2, id+1)
