...
#
# Usage:
#   bash hpc/slurm/script_full_training/submit_airl_pretrain_finetune_5day.bash
#
# Useful overrides:
...
PRETRAIN_SCRIPT="${PRETRAIN_SCRIPT:-${REPODIR}/hpc/slurm/script_pretrain/train_airl_continuous_gpu_32c_stage1_50veh.bash}"
FINETUNE_SCRIPT="${FINETUNE_SCRIPT:-${REPODIR}/hpc/slurm/script_finetune/train_airl_continuous_gpu_32c_stage2_100veh.bash}"
...
PRETRAIN_CHECKPOINT="${PRETRAIN_CHECKPOINT:-${VFI_LOG_ROOT}/airl/${PRETRAIN_RUN_NAME}/final.pt}"
