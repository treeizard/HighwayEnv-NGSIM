...
#
# Usage:
#   bash hpc/slurm/script_full_training/submit_gail_pretrain_finetune_5day.bash
#
# Useful overrides:
...
ENABLE_VENDI_DIAGNOSTICS="${ENABLE_VENDI_DIAGNOSTICS:-true}"
...
PRETRAIN_SCRIPT="${PRETRAIN_SCRIPT:-${REPODIR}/hpc/slurm/script_pretrain/train_gail_continuous_gpu_32c_stage1_50veh.bash}"
FINETUNE_SCRIPT="${FINETUNE_SCRIPT:-${REPODIR}/hpc/slurm/script_finetune/train_gail_continuous_gpu_32c_stage2_100veh.bash}"
...
PRETRAIN_CHECKPOINT="${PRETRAIN_CHECKPOINT:-${VFI_LOG_ROOT}/simple_ps_gail/${PRETRAIN_RUN_NAME}/final.pt}"
...
FINETUNE_COLLISION_PENALTY="${FINETUNE_COLLISION_PENALTY:-2.0}"
FINETUNE_OFFROAD_PENALTY="${FINETUNE_OFFROAD_PENALTY:-2.0}"
FINETUNE_POLICY_BC_REGULARIZATION_COEF="${FINETUNE_POLICY_BC_REGULARIZATION_COEF:-0.0}"
FINETUNE_POLICY_BC_REGULARIZATION_FINAL_COEF="${FINETUNE_POLICY_BC_REGULARIZATION_FINAL_COEF:-0.0}"
FINETUNE_POLICY_BC_REGULARIZATION_DECAY_ROUNDS="${FINETUNE_POLICY_BC_REGULARIZATION_DECAY_ROUNDS:-0}"
...
common_exports="${common_exports},ENABLE_VENDI_DIAGNOSTICS=${ENABLE_VENDI_DIAGNOSTICS},VENDI_MAX_WINDOWS=${VENDI_MAX_WINDOWS},VENDI_RBF_SIGMA=${VENDI_RBF_SIGMA},VENDI_SAFE_ONLY=${VENDI_SAFE_ONLY},VENDI_SEED=${VENDI_SEED}"
...
finetune_exports="${finetune_exports},COLLISION_PENALTY=${FINETUNE_COLLISION_PENALTY},OFFROAD_PENALTY=${FINETUNE_OFFROAD_PENALTY}"
finetune_exports="${finetune_exports},POLICY_BC_REGULARIZATION_COEF=${FINETUNE_POLICY_BC_REGULARIZATION_COEF},POLICY_BC_REGULARIZATION_FINAL_COEF=${FINETUNE_POLICY_BC_REGULARIZATION_FINAL_COEF},POLICY_BC_REGULARIZATION_DECAY_ROUNDS=${FINETUNE_POLICY_BC_REGULARIZATION_DECAY_ROUNDS}"
