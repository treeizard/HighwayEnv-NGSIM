...
#SBATCH --mem=128G
#SBATCH --output=logs/ps_airl_stage2_100veh_%j.out
#SBATCH --error=logs/ps_airl_stage2_100veh_%j.err
...
AIRL_TRAIN_MODULE="${AIRL_TRAIN_MODULE:-scripts_gail.train_simple_airl}"
RUN_NAME="${RUN_NAME:-ps_airl_stage2_100veh_${SLURM_JOB_ID}}"
ALGORITHM_VARIANT="${ALGORITHM_VARIANT:-airl_bce}"
...
DISC_LEARNING_RATE="${DISC_LEARNING_RATE:-0.0001}"
...
echo "AIRL trainer module: ${AIRL_TRAIN_MODULE}"
echo "Scene: ${SCENE}"
