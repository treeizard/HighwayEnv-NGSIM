...
#SBATCH --mem=128G
#SBATCH --output=logs/ps_unified_collect_test_%j.out
#SBATCH --error=logs/ps_unified_collect_test_%j.err
...
mkdir -p "${VFI_DATA_ROOT}/expert"
mkdir -p "${VFI_DATA_ROOT}/expert/videos"
...
OUT="${OUT:-${VFI_DATA_ROOT}/expert/ngsim_ps_unified_expert_continuous_${PREBUILT_SPLIT}_${SLURM_JOB_ID}}"
VIDEO_DIR="${VIDEO_DIR:-${VFI_DATA_ROOT}/expert/videos/${PREBUILT_SPLIT}_${SLURM_JOB_ID}}"
