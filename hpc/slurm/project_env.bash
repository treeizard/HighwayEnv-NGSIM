...
export VFI_RESULTS_ROOT="${VFI_RESULTS_ROOT:-${VFI_PROJECT_ROOT}/results}"
...
export PYTHONPYCACHEPREFIX="${PYTHONPYCACHEPREFIX:-${VFI_LOG_ROOT}/python_pycache/${SLURM_ARRAY_JOB_ID:-${SLURM_JOB_ID:-interactive}}_${SLURM_ARRAY_TASK_ID:-0}}"
