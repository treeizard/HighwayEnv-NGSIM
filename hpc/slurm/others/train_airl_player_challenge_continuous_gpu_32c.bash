...
#SBATCH --mem=128G
#SBATCH --output=logs/ps_airl_challenge_32c_%j.out
#SBATCH --error=logs/ps_airl_challenge_32c_%j.err
...
cd "${REPODIR}"
mkdir -p "${VFI_LOG_ROOT}/airl" "${MPLCONFIGDIR}"
...
echo "AIRL train module: ${AIRL_TRAIN_MODULE}"
