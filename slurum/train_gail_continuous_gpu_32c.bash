...
WARMUP_DISC_UPDATES_PER_ROUND="${WARMUP_DISC_UPDATES_PER_ROUND:-1}"
WARMUP_GAIL_REWARD_CLIP="${WARMUP_GAIL_REWARD_CLIP:-2.0}"
WARMUP_FINAL_REWARD_CLIP="${WARMUP_FINAL_REWARD_CLIP:-5.0}"
VEHICLE_INCREASE_WARMUP_ROUNDS="${VEHICLE_INCREASE_WARMUP_ROUNDS:-10}"
ROLLOUT_TARGET_AGENT_STEPS="${ROLLOUT_TARGET_AGENT_STEPS:-0}"
INITIAL_ROLLOUT_TARGET_AGENT_STEPS="${INITIAL_ROLLOUT_TARGET_AGENT_STEPS:-40000}"
FINAL_ROLLOUT_TARGET_AGENT_STEPS="${FINAL_ROLLOUT_TARGET_AGENT_STEPS:-160000}"
ROLLOUT_TARGET_AGENT_STEPS_CURRICULUM_ROUNDS="${ROLLOUT_TARGET_AGENT_STEPS_CURRICULUM_ROUNDS:-${TOTAL_ROUNDS}}"
ROLLOUT_TARGET_AGENT_STEPS_SCHEDULE="${ROLLOUT_TARGET_AGENT_STEPS_SCHEDULE:-0:900:40000:40000;900:1100:160000:160000}"
...
POLICY_BC_REGULARIZATION_COEF="${POLICY_BC_REGULARIZATION_COEF:-0.10}"
POLICY_BC_REGULARIZATION_FINAL_COEF="${POLICY_BC_REGULARIZATION_FINAL_COEF:-0.02}"
