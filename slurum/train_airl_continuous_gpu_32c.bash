...
CONTROLLED_VEHICLE_SCHEDULE="${CONTROLLED_VEHICLE_SCHEDULE:-0:100:10:20;100:200:20:30;200:300:30:40;300:400:40:50;400:500:50:50;500:600:50:100;600:800:100:100}"
CONTROLLED_VEHICLE_CURRICULUM="${CONTROLLED_VEHICLE_CURRICULUM:-true}"
WARMUP_ROUNDS="${WARMUP_ROUNDS:-0}"
WARMUP_LEARNING_RATE="${WARMUP_LEARNING_RATE:-3e-4}"
WARMUP_DISC_LEARNING_RATE="${WARMUP_DISC_LEARNING_RATE:-2e-5}"
WARMUP_ENTROPY_COEF="${WARMUP_ENTROPY_COEF:-0.04}"
WARMUP_CLIP_RANGE="${WARMUP_CLIP_RANGE:-0.20}"
