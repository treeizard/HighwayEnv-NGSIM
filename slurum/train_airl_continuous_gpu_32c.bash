...
DISC_LEARNING_RATE_SCHEDULE="${DISC_LEARNING_RATE_SCHEDULE:-0:100:2e-5:5e-5;100:500:5e-5:5e-5;500:600:2e-5:5e-5;600:800:5e-5:5e-5}"
DISC_UPDATES_PER_ROUND="${DISC_UPDATES_PER_ROUND:-2}"
DISC_UPDATES_PER_ROUND_SCHEDULE="${DISC_UPDATES_PER_ROUND_SCHEDULE:-0:100:1:2;100:500:2:2;500:600:1:2;600:800:2:2}"
...
python "${AIRL_TRAIN_SCRIPT}" \
    ...
    --wandb-tags ps-airl,airl,${DISCRIMINATOR_LOSS},continuous,unified-expert,curriculum,gpu,32c,vehicle-${CONTROLLED_VEHICLE_SCHEDULE_PROFILE},disc-updates-${DISC_UPDATES_PER_ROUND} \
    --run-name "${RUN_NAME}"
