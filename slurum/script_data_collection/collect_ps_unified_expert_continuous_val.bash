#!/bin/bash
#SBATCH --job-name=ps_unified_expert_val
#SBATCH --account=bt60
#SBATCH --time=24:00:00
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=32
#SBATCH --mem=128G
#SBATCH --output=/home/ytao0016/bt60/ytao0016/HighwayEnv-NGSIM/logs/ps_unified_collect_val_%j.out
#SBATCH --error=/home/ytao0016/bt60/ytao0016/HighwayEnv-NGSIM/logs/ps_unified_collect_val_%j.err
...
PREBUILT_SPLIT="${PREBUILT_SPLIT:-val}"
