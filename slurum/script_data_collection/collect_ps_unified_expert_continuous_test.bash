#!/bin/bash
#SBATCH --job-name=ps_unified_expert_test
#SBATCH --account=bt60
#SBATCH --time=24:00:00
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=32
#SBATCH --mem=128G
#SBATCH --output=/home/ytao0016/bt60/ytao0016/HighwayEnv-NGSIM/logs/ps_unified_collect_test_%j.out
#SBATCH --error=/home/ytao0016/bt60/ytao0016/HighwayEnv-NGSIM/logs/ps_unified_collect_test_%j.err
...
PREBUILT_SPLIT="${PREBUILT_SPLIT:-test}"
OUT="${OUT:-${REPODIR}/expert_data/ngsim_ps_unified_expert_continuous_${PREBUILT_SPLIT}_${SLURM_JOB_ID}}"
VIDEO_DIR="${VIDEO_DIR:-${REPODIR}/expert_data/videos/${PREBUILT_SPLIT}_${SLURM_JOB_ID}}"
