...
# Previous low-KL default: LEARNING_RATE="${LEARNING_RATE:-1e-4}"
LEARNING_RATE="${LEARNING_RATE:-1.5e-4}"
LEARNING_RATE_SCHEDULE="${LEARNING_RATE_SCHEDULE:-}"
DISC_LEARNING_RATE="${DISC_LEARNING_RATE:-2e-4}"
...
# Previous low-KL default: PPO_EPOCHS="${PPO_EPOCHS:-2}"
PPO_EPOCHS="${PPO_EPOCHS:-3}"
ENTROPY_COEF="${ENTROPY_COEF:-0.02}"
ENTROPY_COEF_SCHEDULE="${ENTROPY_COEF_SCHEDULE:-}"
# Previous low-KL default: CLIP_RANGE="${CLIP_RANGE:-0.08}"
