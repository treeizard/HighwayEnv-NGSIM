...
echo "Transformer: layers=${TRANSFORMER_LAYERS} heads=${TRANSFORMER_HEADS} dropout=${TRANSFORMER_DROPOUT} temporal=${TRANSFORMER_TEMPORAL_MODULE} kernel=${TRANSFORMER_TEMPORAL_KERNEL_SIZE} temporal_layers=${TRANSFORMER_TEMPORAL_LAYERS}"
...
python "${REPODIR}/scripts_gail/train_simple_ps_gail.py" \
    ...
    "${TRANSFORMER_TEMPORAL_MODULE_ARG}" \
