...
INITIAL_CONTROLLED_VEHICLES="${INITIAL_CONTROLLED_VEHICLES:-100}"
...
CONTROLLED_VEHICLE_SCHEDULE_GRADUAL="${CONTROLLED_VEHICLE_SCHEDULE_GRADUAL:-0:50:20:40;50:120:40:70;120:200:70:100}"
...
WARMUP_ENTROPY_COEF="${WARMUP_ENTROPY_COEF:-0.005}"
...
COLLISION_PENALTY="${COLLISION_PENALTY:-4.0}"
OFFROAD_PENALTY="${OFFROAD_PENALTY:-4.0}"
POLICY_BC_REGULARIZATION_COEF="${POLICY_BC_REGULARIZATION_COEF:-0.05}"
POLICY_BC_REGULARIZATION_FINAL_COEF="${POLICY_BC_REGULARIZATION_FINAL_COEF:-0.0}"
POLICY_BC_REGULARIZATION_DECAY_ROUNDS="${POLICY_BC_REGULARIZATION_DECAY_ROUNDS:-100}"
