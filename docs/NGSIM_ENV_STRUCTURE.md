...
This note describes how [`NGSimEnv`](../../src/highway_env/envs/ngsim_env.py) is organized and how it interacts with the utilities in [`highway_env/ngsim_utils`](../../src/highway_env/ngsim_utils).
...
- [`road/gen_road.py`](../../src/highway_env/ngsim_utils/road/road/gen_road.py): builds road topology
- [`road/lane_mapping.py`](../../src/highway_env/ngsim_utils/road/lane_mapping.py): maps `x` and dataset `lane_id` to valid road edges/lane indices

## Vehicle Roles

### EgoVehicle

[`EgoVehicle`](../../src/highway_env/ngsim_utils/vehicles/ego.py) is the controlled vehicle used by the environment.
...
[`NGSIMVehicle`](../../src/highway_env/ngsim_utils/vehicles/replay.py) is used for surrounding vehicles.
...
- [`setup_expert_tracker()`](../../src/highway_env/ngsim_utils/road/lane_mapping.py#L133)
- [`PurePursuitTracker`](../../src/highway_env/ngsim_utils/expert/expert/trajectory_to_action.py)
- [`map_discrete_expert_action()`](../../src/highway_env/ngsim_utils/expert/expert/trajectory_to_action.py)
...
- [`ngsim_env.py`](../../src/highway_env/envs/ngsim_env.py): main environment orchestration
- [`road/lane_mapping.py`](../../src/highway_env/ngsim_utils/road/lane_mapping.py): lane mapping and helper utilities
- [`road/gen_road.py`](../../src/highway_env/ngsim_utils/road/road/gen_road.py): road builders
- [`vehicles/ego.py`](../../src/highway_env/ngsim_utils/vehicles/ego.py): ego control logic
- [`vehicles/replay.py`](../../src/highway_env/ngsim_utils/vehicles/replay.py): surrounding replay vehicles
- [`data/trajectory_gen.py`](../../src/highway_env/ngsim_utils/data/data/trajectory_gen.py): trajectory conversion
- [`expert/trajectory_to_action.py`](../../src/highway_env/ngsim_utils/expert/expert/trajectory_to_action.py): expert tracking/action conversion

## Suggested Reading Order

1. [`ngsim_env.py`](../../src/highway_env/envs/ngsim_env.py)
2. [`road/lane_mapping.py`](../../src/highway_env/ngsim_utils/road/lane_mapping.py)
3. [`road/gen_road.py`](../../src/highway_env/ngsim_utils/road/road/gen_road.py)
4. [`vehicles/ego.py`](../../src/highway_env/ngsim_utils/vehicles/ego.py)
5. [`vehicles/replay.py`](../../src/highway_env/ngsim_utils/vehicles/replay.py)
6. [`expert/trajectory_to_action.py`](../../src/highway_env/ngsim_utils/expert/expert/trajectory_to_action.py)
